...
class CandleDataFactory:
    ...
    @staticmethod
    def create_random(timestamp: int, previous_candle: Optional[CandleData] = None, 
                     base_price: float = 50000.0, volatility: float = 0.01) -> CandleData:
        """
    ...
    @staticmethod
    def create_trending_series(start_timestamp: int, count: int, interval_seconds: int,
                              start_price: float = 50000.0, trend: float = 0.001, 
                              volatility: float = 0.005) -> List[CandleData]:
        """
    ...
    @staticmethod
    def create_price_event(candles: List[CandleData], event_index: int, 
                          event_magnitude: float = 0.05) -> List[CandleData]:
        """
    ...
    @staticmethod
    def create_market_simulation(start_timestamp: int, count: int, 
                               interval_seconds: int, 
                               initial_price: float = 50000.0) -> List[CandleData]:
        """
