    ...
    async def run_benchmark(
        ...
        **operation_kwargs
        ...
        result = BenchmarkResult(
            ...
            operations_per_second=len(successful_metrics) / total_duration if total_duration > 0 else 0,
            ...
            memory_peak_mb=max([m.memory_peak_mb for m in self.profiler.metrics], default=start_memory),
