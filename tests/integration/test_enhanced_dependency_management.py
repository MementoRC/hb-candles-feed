...
class TestEnhancedDependencyManagement:
    ...
    async def test_concurrent_external_dependency_access(self, enhanced_mock_server):
        ...
        try:
            ...
            tasks = [
                fetch_for_feed(feed, pair) 
                for feed, pair in zip(feeds, trading_pairs)
            ]
        ...
        try:
            ...
            test_scenarios = [
                ...
                },
                {
                    ...
                    "conditions": {"latency_ms": 50, "packet_loss_rate": 0.005, "error_rate": 0.001},
            ...
            enhanced_mock_server.set_network_conditions(
                latency_ms=20, packet_loss_rate=0.0, error_rate=0.3  # High error rate for rate limiting
            )
