"""
Unit tests for the CandleData class in mocking_resources.
"""
...
class TestCandleData(unittest.TestCase):
    ...
    def test_create_random_no_previous(self):
        ...
        candle = CandleDataFactory.create_random(
            timestamp=timestamp, base_price=base_price, volatility=volatility
        )
    ...
    def test_create_random_with_previous(self):
        ...
        # Act
        candle = CandleDataFactory.create_random(
            timestamp=timestamp, previous_candle=prev_candle, volatility=0.01
        )
