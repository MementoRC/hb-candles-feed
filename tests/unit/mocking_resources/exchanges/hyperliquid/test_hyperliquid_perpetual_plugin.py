...
class TestHyperliquidPerpetualPlugin:
    ...
    async def test_parse_rest_candles_params(self):
        ...
        request._read_bytes = b'{"type":"candles","coin":"BTC","resolution":"60","limit":100,"startTime":1620000000,"endTime":1620100000}'
    ...
    def test_format_ws_candle_message(self):
        ...
        assert message["interval"] == "60"  # Converted from 1m to 60
    ...
    def test_create_ws_subscription_key(self):
        ...
        # Check key format
        assert key == "BTC:60"  # Base asset and interval in seconds