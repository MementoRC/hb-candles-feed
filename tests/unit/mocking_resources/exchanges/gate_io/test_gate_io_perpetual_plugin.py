...
class TestGateIoPerpetualPlugin:
    ...
    async def test_parse_rest_candles_params(self):
        ...
        request = web.Request(
            method="GET",
            url=web.URL("http://test/api/v4/futures/usdt/candlesticks"),
            headers={},
            host="test",
            writer=None,
            task=None,
        ...
        request._rel_url = web.URL("http://test/api/v4/futures/usdt/candlesticks?currency_pair=BTC_USDT&interval=1m&limit=100&from=1620000000&to=1620100000")
