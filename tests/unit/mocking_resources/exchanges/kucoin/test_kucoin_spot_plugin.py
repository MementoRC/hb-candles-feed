...
class TestKucoinSpotPlugin:
    ...
    async def test_parse_rest_candles_params(self):
        ...
        request = web.Request(
            method="GET",
            url=web.URL("http://test/api/v1/market/candles"),
            headers={},
            host="test",
            writer=None,
            task=None,
        ...
        request._rel_url = web.URL("http://test/api/v1/market/candles?symbol=BTC-USDT&type=1min&startAt=1620000000&endAt=1620100000&limit=100")
