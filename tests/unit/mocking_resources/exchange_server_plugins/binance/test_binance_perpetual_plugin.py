"""
Unit tests for the BinancePerpetualPlugin class.
"""
...
class TestBinancePerpetualPlugin:
    """Test suite for the BinancePerpetualPlugin."""

    def setup_method(self):
        """Set up the test."""
        self.plugin = BinancePerpetualPlugin()
        self.trading_pair = "BTC-USDT"
        self.interval = "1m"

    def test_initialization(self):
        """Test plugin initialization."""
        assert self.plugin.exchange_type == ExchangeType.BINANCE_PERPETUAL
    ...
    def test_rest_routes(self):
        ...
        assert "/fapi/v1/klines" in routes
        assert routes["/fapi/v1/klines"][0] == "GET"
        assert routes["/fapi/v1/klines"][1] == "handle_klines"
        assert "/fapi/v1/exchangeInfo" in routes
