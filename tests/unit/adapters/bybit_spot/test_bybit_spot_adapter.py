"""
Unit tests for the BybitSpotAdapter class.
"""
...
from candles_feed.adapters.bybit_spot.constants import (
    ...
    MAX_RESULTS_PER_CANDLESTICK_REST_REQUEST, INTERVAL_TO_BYBIT_FORMAT
)
from candles_feed.core.candle_data import CandleData


class TestBybitSpotAdapter:
    """Test suite for the BybitSpotAdapter class."""
    
    def setup_method(self):
        """Setup method called before each test."""
        self.adapter = BybitSpotAdapter()
    ...
    def test_parse_ws_message_invalid(self):
        ...
        ws_message = {"topic": "trades", "data": "some_data"}
